...
clan1.innerHTML = (`Clan: ${q.personal.clan} Aldea: ${q.personal.affiliation[0]}`)
habilidad1.innerHTML = (`Habilidad: ${q.jutsu[5]}`)
...
clan2.innerHTML = (`Clan: ${r.personal.clan} Aldea: ${r.personal.affiliation[0]}`)
habilidad2.innerHTML = (`Habilidad: ${r.jutsu[1]}`)
...
clan3.innerHTML = (`Clan: ${s.personal.clan} Aldea: ${s.personal.affiliation[0]}`)
habilidad3.innerHTML = (`Habilidad: ${s.jutsu[1]}`)
...
clan4.innerHTML = (`Clan: No clan Aldea: ${t.personal.affiliation[0]}`)
habilidad4.innerHTML = (`Habilidad: ${t.jutsu[1]}`)