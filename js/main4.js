...
clan1.innerHTML = (`Clan: No clanAldea: ${m.personal.affiliation[0]}`)
habilidad1.innerHTML = (`Habilidad: ${m.jutsu[5]}`)
...
clan2.innerHTML = (`Clan: No clan Aldea: ${n.personal.affiliation[0]}`)
habilidad2.innerHTML = (`Habilidad: ${n.jutsu[1]}`)
...
habilidad3.innerHTML = (`Habilidad: ${o.jutsu[1]}`)
...
habilidad4.innerHTML = (`Habilidad: ${p.jutsu[1]}`)